 ...
 * 老师端的待实习界面
 */
public class WaitPracticeFragment extends Fragment {
    @BindView(R.id.rv)
    RecyclerView rv;
        ...
        rv.setAdapter(new BaseQuickAdapter<StudiesBean.DataBean>(R.layout.wait_practice_fragment_item, list) {
            ...
            protected void convert(BaseViewHolder baseViewHolder, final StudiesBean.DataBean dataBean) {
                ...
                if (dataBean.getInternStartTime() != null && !TextUtils.isEmpty(dataBean.getInternStartTime()) &&
                        dataBean.getInternEndTime() != null && !TextUtils.isEmpty(dataBean.getInternEndTime())) {
    ...
    private void getData() {
        String params = "?usrId=" + String.valueOf(id) + "&isStu=0&status=120";
