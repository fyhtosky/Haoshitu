 ...
 * 老师端不合适的聊天记录
 */
public class OutMessageListFragment extends Fragment {
    ...
    //筛选不合适的数据源
    private List<RecentlyMsgBean.DataBean>noList=new ArrayList<>();
    //适配器
    ...
    private void init() {
        ...
        teachterMessageListAdapter=new TeachterMessageListAdapter(getContext(),noList);
