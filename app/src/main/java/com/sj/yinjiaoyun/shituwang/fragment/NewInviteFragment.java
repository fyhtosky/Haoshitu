 ...
 */
public class NewInviteFragment extends Fragment {
    @BindView(R.id.rv)
    RecyclerView rv;
    ...
    private void init() {
        ...
        rv.setAdapter(new BaseQuickAdapter<StudiesBean.DataBean>(R.layout.pend_fragment_item, list) {
            @Override
...
//                        StudentInterviewActivity.StartActivity(getContext(),dataBean.getId());
    ...
    private void getData() {
        String params = "?usrId=" + String.valueOf(id) + "&isStu=1&status=101";
