...
public class TerminatedFragment  extends Fragment {
    @BindView(R.id.rv)
    RecyclerView rv;
    ...
    private void init() {
        ...
        rv.setAdapter(new BaseQuickAdapter<StudiesBean.DataBean>(R.layout.termination_fragment_item, list) {
            ...
            protected void convert(BaseViewHolder baseViewHolder, final StudiesBean.DataBean dataBean) {
                ...
                //实习导师
                baseViewHolder.setText(R.id.tv_termination_tutor, "实习导师：" + dataBean.getTeacher().getRealName());
    ...
    private void getData() {
        String params = "?usrId=" + String.valueOf(id) + "&isStu=1&status=123,124";
