...
public class PopPortayal {
    ...
    public PopPortayal(Activity activity) {
    ...
    public void pop(final View view){
        ...
        CreditScoreView creditScoreView= (CreditScoreView) pView.findViewById(R.id.credit_view);
        //设置点的数量
...
//        Button btRecomend= (Button) pView.findViewById(R.id.bt_recommend);
        Button btInfo= (Button) pView.findViewById(R.id.bt_info);
        //点击推荐按钮
//        btRecomend.setOnClickListener(new View.OnClickListener() {
//            @Override
