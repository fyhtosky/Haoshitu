 ...
 * 已面试中的已实习界面
 */
public class HaveInternshipFragment extends Fragment {
    @BindView(R.id.rv)
    RecyclerView rv;
    ...
    private void init() {
        ...
        rv.setAdapter(new BaseQuickAdapter<StudiesBean.DataBean>(R.layout.internship_item, list) {
            @Override
    ...
    private void getData() {
        String params = "?usrId=" + String.valueOf(id) + "&isStu=1&status=122";
