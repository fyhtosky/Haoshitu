...
import com.sj.yinjiaoyun.shituwang.activity.EducationActivity;
...
public class EducationAdapter extends BaseAdapter {
    ...
    public EducationAdapter(Context context, List<StudentRecordBean.DataBean.ResumesBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final EducationHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.record_item2, null);
            holder = new EducationHolder(convertView);
            convertView.setTag(holder);
        } else {
            holder = (EducationHolder) convertView.getTag();
        }
        ...
        if(resumesBean.getResume()!=null && !TextUtils.isEmpty(resumesBean.getResume())){
            ...
            holder.tvRecordItemName.setText(mapstr.get("collegeName"));
            ...
            holder.rlItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    EducationActivity.StartActivity(context,resumesBean);
                }
            });
        }
