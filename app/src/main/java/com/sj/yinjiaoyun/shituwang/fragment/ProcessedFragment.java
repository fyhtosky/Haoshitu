...
public class ProcessedFragment extends Fragment {
    ...
    @BindView(R.id.vp)
    ViewPager vp;
    private List<String> list = Arrays.asList("已接受", "实习中","已实习");
    private List<Fragment> fragmentList = new ArrayList<>();
   //已接受
    private  AcceptedFragment acceptFragment;
    //实习中的
    private InInternshipFragment inInternshipFragment;
    //已实习
    private HaveInternshipFragment haveInternshipFragment;
...
//        4：不合适 studyStatus.interviewFail,studyStatus.internReject,studyStatus.internCancel
        ...
        acceptFragment=new AcceptedFragment();
        ...
        fragmentList.add(inInternshipFragment);
        fragmentList.add(haveInternshipFragment);
